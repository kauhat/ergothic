...
pub fn construct_parameters(name: String, measures: Measures, mut args: CmdArgs) -> Parameters {
    ...
    if args.production_mode {
        ...
        if let Some(mongo) = args.mongo {
            ...
            exporter = Box::new(crate::export::MongoExporter::new(
                &mongo,
                &mongo_db,
                &mongo_coll,
                None,
    ...
    let flush_interval_dist =
        rand::distributions::Uniform::<u64>::new_inclusive(flush_interval_min, flush_interval_max);
